...
affliction_descriptions = {
	...
	:malaria          => 'A disease caused by protozoan parasited in the red blood cells, passed from one individual to another by bite of the mosquitoes, and marked by periodic attacks of chills and fever.',
	:measles          => 'A contagious disease caused by a virus and marked by fever and red spots on the skin.',
	:mumps            => 'An acute contagious virus disease caused by a paramyxovirus and marked by fever and by swelling especially of the partoid gland.',
	:parasite         => 'An organism living in, on, or with another organism in order to obtain nutrients, grow, or multiply oftern in a state that directly or indirectly harms the host.',
	...
	:scarlet_fever    => 'An acute contagious febrile disease caused by hemolytic Group A streptococci and characterized by inflammation of the nose, throad, and mout, generalized toxemia, and a red rash.',
	:smallpox         => 'An acute contagious febrile diesase of humans that is caused by a poxvirus, is characterized by a skin eruption with pustules, slouging, and scar formation.',
